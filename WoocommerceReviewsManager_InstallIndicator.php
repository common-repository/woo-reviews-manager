...
include_once('WoocommerceReviewsManager_OptionsManager.php');

class WoocommerceReviewsManager_InstallIndicator extends WoocommerceReviewsManager_OptionsManager {
