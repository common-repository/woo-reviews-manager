...
include_once('WoocommerceReviewsManager_InstallIndicator.php');

class WoocommerceReviewsManager_LifeCycle extends WoocommerceReviewsManager_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToPluginsMenu() {
        ...
        add_menu_page(
            ...
            $this->getSettingsSlug(),
            array(&$this, 'settingsPage'),
            plugin_dir_url(__FILE__) . 'images/ebay_logo_27x27.png');
